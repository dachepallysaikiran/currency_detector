...
max_pt = -1
max_kp = 0
import cv2 as myalgo
#test_img = read_img('files/inputs/input_500.jpg')
test_img = read_img('files/test_20_2.jpg')
#test_img = read_img('files/test_100_3.jpg')
#test_img = read_img('files/test_20_4.jpg')
#test_img = read_img('files/inputs/input_100.jpg')
#test_img = read_img('files/inputs/input_20.jpg')
#test_img = read_img('files/inputs/input_50.jpg')
orb = myalgo.ORB_create()
